...
void ZombieRender(Zombie *zombie, Shader shader) {
    ...
    DrawModelEx(zombie->model, Vector3Add(zombie->position, (Vector3){ 0, bob, 0 }), (Vector3){ 0, 1, 0 }, 0.0f, (Vector3){ 1, 1.2f, 1 }, (Color){ 80, 100, 70, 255 });
    DrawSphere(zombie->position, 0.35f, (Color){ 90, 110, 80, 255 });
}
